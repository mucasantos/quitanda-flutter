...
class _$Error implements Error {
  ...
  @override
  String toString() {
    return 'AuthResult.error(messageError: $messageError)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(messageError));
...
abstract class Error implements AuthResult {
  factory Error([final String? messageError]) = _$Error;
