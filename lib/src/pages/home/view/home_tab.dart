...
import 'package:quitanda/src/pages/home/view/components/discount_card.dart';
...
class _HomeTabState extends State<HomeTab> {
  ...
  List<String> userFavorites = appData.appUserFavorites;
                          ...
                          itemBuilder: (_, index) {
                            return ItemTile(
                              ...
                              isFavorite: userFavorites
                                  .contains(appData.items[index].objectId),
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (_, index) {
                          return CategoryTile(
                            ...
                            isSelected: controller.allCategories[index].title ==
                                controller.currentCategory!.title,
                            image: controller.allCategories[index].image,
                          );
                        },
